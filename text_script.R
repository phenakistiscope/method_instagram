...
##save to csv
write.csv(df_txt, file ="id_txt_gerhardrichter.csv")
write.csv(df_txt_hash, file ="id_hash_gerhardrichter.csv")
write.csv2(final_df, file ="gephi_gerhardrichter.csv", na = " ")
